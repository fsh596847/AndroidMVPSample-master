...
public class MainAlertDialog {
  ...
  public MainAlertDialog builder() {
    // 获取Dialog布局
  ...
  public MainAlertDialog setTitle(String title) {
    showTitle = true;
    txt_title.setText(title);
    return this;
  }

  public MainAlertDialog setMsg(String msg) {
    showMsg = true;
  ...
  public MainAlertDialog setMsgAlignLeft(String msg) {
    showMsg = true;
  ...
  public MainAlertDialog setCancelable(boolean cancel) {
    dialog.setCancelable(cancel);
    return this;
  }

  public MainAlertDialog setCanceledOnTouchOutside(boolean cancel) {
    dialog.setCanceledOnTouchOutside(cancel);
    return this;
  }

  public MainAlertDialog setPositiveButton(String text) {
    showPosBtn = true;
  ...
  public MainAlertDialog setList(List<String> list) {
    this.list = list;
    adapter.notifyDataSetChanged();
    return this;
  }

  public MainAlertDialog setPositiveButton(String text, final OnClickListener listener) {
    showPosBtn = true;
  ...
  public interface CallPayType {
    void callback(String dataBean, int i);
  }
  ...
  private class MyAdapter extends BaseAdapter {
    ...
    @Override public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      viewHold.tv.setText(list.get(i));
      return view;
    }
