...
public class PrintActivity extends AppCompatActivity implements View.OnClickListener {
            ...
            public void run() {
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        mHandler.obtainMessage(msgQueryDetailResponseFail, e.getMessage())
                            .sendToTarget();
                    }
    ...
    private Bitmap genPrint(boolean toPrint) {
        ...
        drawImag.drawText(leftMargin + 0, cy, pageWidth, lineHeight, "江苏省太湖渔政监督支队划码单",
            titleFontSize, 0);
        cy += lineHeight;
        ...
        cy += lineHeight;
        drawImag.drawText(leftMargin + 0, cy, pageWidth, lineHeight,
            "交货单位：" + dataBean.getUnitname(), contentFontSize, -1);
        ...
        int lineCount = drawImag.drawText(leftMargin + 0, cy, pageWidth, lineHeight,
            "备注：" + (dataBean.getRemark() == null ? "" : dataBean.getRemark()), contentFontSize,
            -1);
        cy += lineHeight / 2;
        if (lineCount > 1) {
        ...
        for (int i = 0; i < (columnCount + 1); i++) {
            ...
            if (i == 8) {
                drawImag.drawVLine(tableX, cy + lineHeight, drawLineHeight,
                    tableY - cy - lineHeight);
            } else {
        ...
        drawImag.drawText(tableX + columnWidth, tableY, columnWidth, lineHeight, "品种",
            contentFontSize, 0);
        ...
        for (int i = 0; i < detailResponse.getData().size(); i++) {
            ...
            drawImag.drawText(tableX + columnWidth * 3 + linepadding, tableY + lineHeight * (i + 1),
                columnWidth, lineHeight, "" + db.getGrossweight(), contentFontSize, 0);
        ...
        drawImag.drawText(tableX, tableY + lineHeight * 11, columnWidth, lineHeight, "合计",
            contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 5 + linepadding, tableY + lineHeight * 11,
            columnWidth, lineHeight, dataBean.getTotalmny(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 6 + linepadding, tableY + lineHeight * 11,
            columnWidth, lineHeight, "" + endNum, contentFontSize, 0);

        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight, columnWidth, lineHeight,
            "件数", contentFontSize, 0);
        ...
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 2, columnWidth,
            lineHeight, "毛重", contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 8, tableY + lineHeight * 2, columnWidth,
            lineHeight, "" + dataBean.getTotalgrossweight(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 3, columnWidth,
            lineHeight, "皮重", contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 8, tableY + lineHeight * 3, columnWidth,
            lineHeight, "" + dataBean.getTotaltareweight(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 4, columnWidth,
            lineHeight, "净重", contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 8, tableY + lineHeight * 4, columnWidth,
            lineHeight, "" + dataBean.getTotalnetweight(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 5, columnWidth,
            lineHeight, "废品", contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 8, tableY + lineHeight * 5, columnWidth,
            lineHeight, "" + dataBean.getTotalwaste(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 6, columnWidth,
            lineHeight, "实重", contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 8, tableY + lineHeight * 6, columnWidth,
            lineHeight, "" + dataBean.getTotalrealweight(), contentFontSize, 0);
        drawImag.drawText(tableX + columnWidth * 7, tableY + lineHeight * 9, columnWidth,
            lineHeight, "调整数", contentFontSize, 0);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (myJmPrinter.open()) { // 打开通讯通道
                            mHandler.obtainMessage(msgOpenPrinterConnected, "已连接到打印机")
                                .sendToTarget();
                            ...
                            mHandler.obtainMessage(msgOpenPrinterFail, "无法连接打印机,错误码是：" + ErrCode)
                                .sendToTarget();
                        }
                    } catch (Exception e) {
                        mHandler.obtainMessage(msgOpenPrinterFail, "打印出错：" + e.getMessage())
                            .sendToTarget();
                    } finally {
                        if (myJmPrinter != null) {
    ...
    public static byte[] getTextByteData(PrinterType printerType) {
        ...
        if (printerType == PrinterType.PT_DOT24) { // PT_DOT24支持的打印机指令
            ...
            // 打印默认字体
            strToByte =
                ByteArrayUtils.twoToOne(strToByte, ByteArrayUtils.stringToByte("默认字体：\r\n"));
            strToByte =
                ByteArrayUtils.twoToOne(strToByte, ByteArrayUtils.stringToByte(chineseContent));
            strToByte =
                ByteArrayUtils.twoToOne(strToByte, ByteArrayUtils.stringToByte(englishContent));
