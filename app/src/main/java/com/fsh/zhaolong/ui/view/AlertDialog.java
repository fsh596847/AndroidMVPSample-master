...
public class AlertDialog {
  ...
  private List<AddResponse.DataBean> list=new ArrayList<>();
  ...
  public AlertDialog setList(List<AddResponse.DataBean> list) {
    this.list=list;
  ...
  public interface CallPayType {
    void callback(AddResponse.DataBean dataBean,int i);
  }
  ...
  private  class MyAdapter extends BaseAdapter{
    ...
    @Override public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      viewHold.tv.setText(list.get(i).getVarietyname());
      return view;
    }
